 ...
 * @author user
 */
public class pending_Registration extends javax.swing.JFrame {
    ...
    public pending_Registration() {
        initComponents();
        populateTable();
    }
    
    public pending_Registration(String staffName, String tpNum, String Password, String email, String contact) {
        initComponents();
        populateTable();
